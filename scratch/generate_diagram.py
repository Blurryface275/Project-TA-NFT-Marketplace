...
svg_content = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1480 1020" width="100%" height="100%" style="background:#ffffff; font-family:'Segoe UI',-apple-system,BlinkMacSystemFont,Roboto,Helvetica,Arial,sans-serif;">
  <defs>
    <!-- Shadow Filter -->
  ...
  <rect x="1270" y="40" width="140" height="28" rx="14" fill="#334155"/>
  <text x="1340" y="58" fill="#38bdf8" font-size="11" font-weight="600" text-anchor="middle">Sepolia &amp; ERC-4337</text>
  ...
  <!-- ========================================== -->
  <rect x="40" y="680" width="1400" height="310" rx="10" fill="#f8fafc" stroke="#cbd5e1" stroke-width="1.5" filter="url(#tier-shadow)"/>
  ...
  <g filter="url(#card-shadow)">
    <rect x="60" y="728" width="370" height="242" rx="8" fill="#ffffff" stroke="#fcd34d" stroke-width="1.5"/>
    ...
    <text x="75" y="817" fill="#1e293b" font-size="11" font-weight="600">🪪 kyc_records &amp; passkey_credentials</text>
    <text x="93" y="832" fill="#64748b" font-size="10">Foto KTP fisik, status verifikasi, public key passkey</text>
    <text x="75" y="854" fill="#1e293b" font-size="11" font-weight="600">🎪 events &amp; ticket_categories</text>
    <text x="93" y="869" fill="#64748b" font-size="10">Deskripsi lengkap, kuota stok, tanggal/jam, venue</text>
    <text x="75" y="891" fill="#1e293b" font-size="11" font-weight="600">🧾 orders &amp; resale_listings</text>
    <text x="93" y="906" fill="#64748b" font-size="10">Invoice Midtrans, snap token, riwayat pembelian</text>
    <text x="75" y="928" fill="#1e293b" font-size="11" font-weight="600">🔔 notifications &amp; ticket_cache</text>
    <text x="93" y="943" fill="#64748b" font-size="10">Log notifikasi dan cache data tiket untuk performa</text>
  </g>

  <!-- Decentralized Storage (IPFS Pinata) -->
  <g filter="url(#card-shadow)">
    <rect x="450" y="728" width="330" height="242" rx="8" fill="#ffffff" stroke="#6ee7b7" stroke-width="1.5"/>
    ...
    <text x="465" y="820" fill="#1e293b" font-size="11" font-weight="600">📄 Ticket Metadata JSON</text>
    <text x="483" y="836" fill="#64748b" font-size="10">Nama event, venue, jadwal, deskripsi, atribut tiket</text>
    <text x="465" y="860" fill="#1e293b" font-size="11" font-weight="600">🔗 Standar tokenURI (ERC-721)</text>
    <text x="483" y="876" fill="#64748b" font-size="10">URI IPFS terdesentralisasi tidak bisa diubah pihak luar</text>
    <text x="465" y="900" fill="#1e293b" font-size="11" font-weight="600">🛡️ Pinata Pinning Guarantee</text>
    <text x="483" y="916" fill="#64748b" font-size="10">Menjamin file tetap tersedia di jaringan IPFS global</text>
    <text x="465" y="942" fill="#047857" font-size="10" font-weight="600">ipfs://Qm... (CID Hash)</text>
  </g>

  <!-- Sepolia Testnet Blockchain -->
  <g filter="url(#card-shadow)">
    <rect x="800" y="728" width="620" height="242" rx="8" fill="#ffffff" stroke="#67e8f9" stroke-width="1.5"/>
    ...
    <!-- Paymaster Sub-Box -->
    <rect x="815" y="768" width="590" height="42" rx="6" fill="#f0fdfa" stroke="#99f6e4" stroke-width="1"/>
    <text x="830" y="786" fill="#115e59" font-size="11" font-weight="700">⚡ ERC-4337 Account Abstraction (Paymaster &amp; Bundler Service)</text>
    <text x="830" y="801" fill="#0f766e" font-size="10">Mensponsori gas fee transaksi minting/resale secara penuh sehingga pengguna bebas gas (Gasless UX)</text>

    <!-- TicketContract.sol -->
    <rect x="815" y="820" width="285" height="138" rx="6" fill="#f8fafc" stroke="#38bdf8" stroke-width="1.2"/>
    <text x="825" y="838" fill="#0369a1" font-size="11" font-weight="700">📜 TicketContract.sol (ERC-721)</text>
    <text x="825" y="856" fill="#334155" font-size="10" font-weight="600">• originalPrice Locked</text>
    <text x="835" y="869" fill="#64748b" font-size="9.5">Harga awal permanen di struct TicketInfo</text>
    <text x="825" y="885" fill="#334155" font-size="10" font-weight="600">• userIdentities (NIK Hash)</text>
    <text x="835" y="898" fill="#64748b" font-size="9.5">mapping(address => bytes32) hash NIK KTP</text>
    <text x="825" y="914" fill="#334155" font-size="10" font-weight="600">• Allowlist Transfer Hook</text>
    <text x="835" y="927" fill="#64748b" font-size="9.5">Blokir transfer P2P liar; hanya via marketplace</text>
    <text x="825" y="943" fill="#334155" font-size="10" font-weight="600">• markUsed() Venue Validation</text>

    <!-- MarketplaceContract.sol -->
    <rect x="1115" y="820" width="290" height="138" rx="6" fill="#f8fafc" stroke="#38bdf8" stroke-width="1.2"/>
    <text x="1125" y="838" fill="#0369a1" font-size="11" font-weight="700">🏪 MarketplaceContract.sol</text>
    <text x="1125" y="856" fill="#334155" font-size="10" font-weight="600">• Resale Price-Lock (Anti-Scalping)</text>
    <text x="1135" y="869" fill="#64748b" font-size="9.5">Harga resale = TicketContract.originalPrice</text>
    <text x="1125" y="885" fill="#334155" font-size="10" font-weight="600">• Zero-Profit Secondary Market</text>
    <text x="1135" y="898" fill="#64748b" font-size="9.5">Mematikan insentif calo &amp; spekulan tiket</text>
    <text x="1125" y="914" fill="#334155" font-size="10" font-weight="600">• Sah via Jalur Allowlist</text>
    <text x="1135" y="927" fill="#64748b" font-size="9.5">Memindahkan NFT dari seller ke buyer baru</text>
    <text x="1125" y="943" fill="#334155" font-size="10" font-weight="600">• Admin Fee Distribution</text>
  </g>
...
print("SVG created successfully at d:/STEVE/Project NFT Marketplace/design/arsitektur-sistem.svg")
...
print("HTML created successfully at d:/STEVE/Project NFT Marketplace/design/arsitektur-sistem.html")
